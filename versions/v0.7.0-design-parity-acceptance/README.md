...
- Compatibility: Pending preceding-version results.
- Migration/rollback: No planned data migration.
...
- [ ] Residual scope moved to backlog or accepted explicitly.
- [ ] Implementation refs and final repository states recorded.
